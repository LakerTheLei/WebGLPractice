//当两个绘制的物体Z相同的时候，会产生深度冲突，即Zfighting，WebGL提供了多边形偏移(polygon offset),该机制自动在Z值加上一个偏移量，偏移量的值由观察者视线角度决定
//启动过程
//1.启动多边形偏移gl.enable(gl.POLYGON_OFFSET_FILL);
//2.设置偏移量gl.polygonOffset(1, 1);
